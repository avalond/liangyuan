...
package com.xiaan.liangyuan.liangyuanapp.BlueToothLeService;
...
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.BloodPressureParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.CSCParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.CapSenseParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.DescriptorParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.GlucoseParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.HRMParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.HTMParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.RGBParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.RSCParser;
import com.xiaan.liangyuan.liangyuanapp.BLEProfileDataParserClasses.SensorHubParser;
...
public class BluetoothLeService extends Service {
	...
	private final static BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
			...
			if (status == BluetoothGatt.GATT_SUCCESS) {
				LoggerUtils.d(TAG,"onDescriptorWrite GATT_SUCCESS------------------->SUCCESS");
			} else if (status == BluetoothGatt.GATT_FAILURE) {
				LoggerUtils.d(TAG,"onDescriptorWrite GATT_FAIL------------------->FAIL");
	...
	public boolean initialize() {
		LoggerUtils.d(TAG, "BLEService----------------->initialize");
